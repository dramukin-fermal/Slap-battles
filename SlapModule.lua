...
return function(glove, mob, special)
	local special = special or false
	if GlovehitsTable[glove] then
		GlovehitsTable[glove]:FireServer(mob, special)
	else
		ReplicatedStorage.GeneralHit:FireServer(mob, special)
	end
end
