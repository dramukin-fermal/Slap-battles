...
local SlapSystem = {}
function SlapSystem.supportCheck(glove)
    return GlovehitsTable and GlovehitsTable[glove] ~= nil
end

function SlapSystem.executeHit(glove, ...)
    local args = {...}
    
    if SlapSystem.supportCheck(glove) then
        GlovehitsTable[glove]:FireServer(unpack(args))
    else
